...
def prediction(dataset_path, client_ip, client_port, server_ip, server_port):
    ...
    model_path = '/home/ubuntu/API_integration_device/Client1/inference_results/modetrained_mult.pth'
    ...
    output_json_path = "/home/ubuntu/API_integration_device/Client1/inference_results/inference_output.json"
    with open(output_json_path, "w") as json_file:
        json.dump(json_data, json_file, indent=4)

    desired_json = {
        "flow_filename": "/home/ubuntu/API_integration_device/Client1/Data/validation_data.csv",
        "model_id": model_id,
        "anomaly_results": [json_data]
    }
    with open("/home/ubuntu/API_integration_device/Client1/inference_results/inference_output.json.json", "w") as json_out:
    ...
    STIX_file = "/home/ubuntu/API_integration_device/Client1/Inference_data.stix"
