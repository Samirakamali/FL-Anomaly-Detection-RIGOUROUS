...
def model_train():
    ...
    attack_labels, flow_features, stix_obj = train(options, client_id="client0", server_url="http://0.0.0.0:8803")
    output_path = '/home/ubuntu/API_integration_device/Client0/metadata_model.stix'
...
def download_stix():
    path = '/home/ubuntu/API_integration_device/Client0/combined_output_bundle.stix'
...
def receive_agg_model():
    ...
    save_dir = "/home/ubuntu/API_integration_device/Client0/model_update"
