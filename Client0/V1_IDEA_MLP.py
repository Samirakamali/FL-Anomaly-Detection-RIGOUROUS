...
@CustomObject('model', [
    ...
    ('binary_class_accuracy', properties.FloatProperty(required=False)),
...
def train(options, client_id, server_url="http://0.0.0.0:8803"):
    ...
    for iter in range(args.epochs):
        if iter == 0:
            ...
            weight_dir = f"/home/ubuntu/API_integration_device/Client0/client_weights_flask"
            ...
            recv_dir = f"/home/ubuntu/API_integration_device/Client0/model_update"
    ...
    torch.save(server.model,'/home/ubuntu/API_integration_device/Client0/inference_results/modetrained_mult.pth') 
    ...
    binary_class_accuracy=final_acc,
    ...
    validation_data_path =  '/home/ubuntu/API_integration_device/Client0/Data/device0_testsandbox.csv' 
    client_ip, client_port = "0.0.0.0", 8001 
    ...
    output_path = '/home/ubuntu/API_integration_device/Client0/combined_output_bundle.stix'
